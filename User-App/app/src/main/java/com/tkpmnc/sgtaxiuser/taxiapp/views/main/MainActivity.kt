package com.tkpmnc.sgtaxiusers.taxiapp.views.main
...
import com.tkpmnc.sgtaxiusers.appcommon.custompalette.CustomTypefaceSpan
import com.tkpmnc.sgtaxiusers.appcommon.database.SqLiteDb
import com.tkpmnc.sgtaxiusers.appcommon.datamodels.JsonResponse
import com.tkpmnc.sgtaxiusers.appcommon.drawpolyline.DirectionsJSONParser
import com.tkpmnc.sgtaxiusers.appcommon.helper.Constants
import com.tkpmnc.sgtaxiusers.appcommon.helper.Constants.Req_TYPE_NORMAL
import com.tkpmnc.sgtaxiusers.appcommon.helper.Constants.Req_TYPE_POOL
import com.tkpmnc.sgtaxiusers.appcommon.helper.Constants.scheduledDuration
import com.tkpmnc.sgtaxiusers.appcommon.helper.LatLngInterpolator
...
import com.tkpmnc.sgtaxiusers.appcommon.map.AppUtils
import com.tkpmnc.sgtaxiusers.appcommon.network.AppController
import com.tkpmnc.sgtaxiusers.appcommon.network.PermissionCamer
import com.tkpmnc.sgtaxiusers.appcommon.placesearch.InfoWindowData
...
import com.tkpmnc.sgtaxiusers.appcommon.utils.CommonMethods.Companion.startChatActivityFrom
import com.tkpmnc.sgtaxiusers.appcommon.utils.CommonMethods.Companion.startSinchService
import com.tkpmnc.sgtaxiusers.appcommon.utils.Enums.REG_GET_PAYMENTMETHOD
import com.tkpmnc.sgtaxiusers.appcommon.utils.Enums.REQ_COMMON_DATA
...
import com.tkpmnc.sgtaxiusers.appcommon.utils.Enums.REQ_NEAREST_CARS
import com.tkpmnc.sgtaxiusers.appcommon.utils.Enums.REQ_SEARCH_CARS
import com.tkpmnc.sgtaxiusers.appcommon.utils.Enums.REQ_SEND_REQUEST
import com.tkpmnc.sgtaxiusers.appcommon.utils.Enums.REQ_TRIP_DETAIL
...
import com.tkpmnc.sgtaxiusers.appcommon.views.BannerActivityCommon
import com.tkpmnc.sgtaxiusers.appcommon.views.CommonActivity
import com.tkpmnc.sgtaxiusers.appcommon.views.SupportActivityCommon
...
import com.tkpmnc.sgtaxiusers.taxiapp.adapters.SeatsListAdapter
import com.tkpmnc.sgtaxiusers.taxiapp.database.AddFirebaseDatabase
import com.tkpmnc.sgtaxiusers.taxiapp.datamodels.DriverLocation
...
import com.tkpmnc.sgtaxiusers.taxiapp.datamodels.main.NearByCarsModel
...
import com.tkpmnc.sgtaxiusers.taxiapp.firebase_keys.FirebaseDbKeys.LIVE_TRACKING_NODE
import com.tkpmnc.sgtaxiusers.taxiapp.firebase_keys.FirebaseDbKeys.TRIP_PAYMENT_NODE
...
import com.tkpmnc.sgtaxiusers.taxiapp.sidebar.payment.AddWalletActivity
...
import com.tkpmnc.sgtaxiusers.taxiapp.singledateandtimepicker.SingleDateAndTimePicker
...
import com.tkpmnc.sgtaxiusers.taxiapp.views.main.filter.FeatureSelectListener
...
import kotlinx.android.synthetic.main.app_nav_header_main.vip_image1
...
class MainActivity : CommonActivity(), SeatsListAdapter.OnClickListener,
    ...
    lateinit var vip_image: ImageView
    ...
    fun logout() {
        ...
        apiService.logOut(sessionManager.accessToken!!, sessionManager.type!!).enqueue(RequestCallback(
            REQ_LOGOUT, this))
        onSuccessLogout()
    }
    /**
    ...
    fun clearApplicationData() {
        ...
        if (appDir.exists()) {
            ...
            for (s in children) {
                if ("lib" != s) {
                    Setting.deleteDir(File(appDir, s))
...
//        navigationView.menu.findItem(R.id.nav_support).isVisible = checkVersionModel.support.isNotEmpty()
        ...
        /*if (sessionManager.Vip == "1"){
            rideicon.visibility = View.VISIBLE
        }else{
            rideicon.visibility = View.GONE
        }*/
    ...
    private fun headerViewset() {
        ...
        vip_image = headerview.findViewById<View>(R.id.vip_image1) as ImageView
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        try {
            ...
            DebuggableLogE("SG Taxi", "Can't find style. Error: ", e)
        }
...
*/
    ...
    private fun onSuccessProfile(jsonResp: String) {
        ...
        sessionManager.firstName = riderProfile.firstName
        sessionManager.lastName = riderProfile.lastName
        sessionManager.Vip = riderProfile.isVip

        if(riderProfile.isVip == "1"){
            rideicon.visibility = View.VISIBLE
            vip_image.visibility = View.VISIBLE
        }else{
            rideicon.visibility = View.GONE
            vip_image.visibility = View.GONE
        }
