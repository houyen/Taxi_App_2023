...
import com.tkpmnc.sgtaxiusers.appcommon.utils.Enums.REQ_SIGNUP
...
//import static com.tkpmnc.sgtaxiusers.appcommon.utils.Enums.REQ_VALIDATE_NUMBER;
...
/*    @BindView(R.id.backArrow)
    ...
    private inner class NameTextWatcher(private val view: View) : TextWatcher {
        ...
        override fun beforeTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
            DebuggableLogI("SG Taxi", "Textchange")
        }
