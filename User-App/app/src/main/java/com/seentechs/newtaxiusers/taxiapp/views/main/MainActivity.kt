...
import com.seentechs.newtaxiusers.appcommon.custompalette.CustomTypefaceSpan
...
import com.seentechs.newtaxiusers.appcommon.drawpolyline.DirectionsJSONParser
import com.seentechs.newtaxiusers.appcommon.helper.Constants
import com.seentechs.newtaxiusers.appcommon.helper.Constants.Req_TYPE_NORMAL
import com.seentechs.newtaxiusers.appcommon.helper.Constants.Req_TYPE_POOL
import com.seentechs.newtaxiusers.appcommon.helper.Constants.scheduledDuration
import com.seentechs.newtaxiusers.appcommon.helper.LatLngInterpolator
import com.seentechs.newtaxiusers.appcommon.helper.Permission
...
import com.seentechs.newtaxiusers.appcommon.map.AppUtils
import com.seentechs.newtaxiusers.appcommon.network.AppController
import com.seentechs.newtaxiusers.appcommon.network.PermissionCamer
import com.seentechs.newtaxiusers.appcommon.placesearch.InfoWindowData
import com.seentechs.newtaxiusers.appcommon.pushnotification.Config
import com.seentechs.newtaxiusers.appcommon.pushnotification.NotificationUtils
...
import com.seentechs.newtaxiusers.appcommon.utils.CommonMethods.Companion.DebuggableLogD
...
import com.seentechs.newtaxiusers.appcommon.utils.CommonMethods.Companion.startChatActivityFrom
import com.seentechs.newtaxiusers.appcommon.utils.CommonMethods.Companion.startSinchService
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REG_GET_PAYMENTMETHOD
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REQ_COMMON_DATA
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REQ_GET_DRIVER
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REQ_GET_RIDER_PROFILE
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REQ_NEAREST_CARS
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REQ_SEARCH_CARS
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REQ_SEND_REQUEST
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REQ_TRIP_DETAIL
import com.seentechs.newtaxiusers.appcommon.utils.Enums.REQ_UPDATE_LOCATION
import com.seentechs.newtaxiusers.appcommon.utils.RequestCallback
import com.seentechs.newtaxiusers.appcommon.utils.RuntimePermissionDialogFragment
import com.seentechs.newtaxiusers.appcommon.views.BannerActivityCommon
import com.seentechs.newtaxiusers.appcommon.views.CommonActivity
import com.seentechs.newtaxiusers.appcommon.views.SupportActivityCommon
...
import com.seentechs.newtaxiusers.taxiapp.datamodels.main.NearestCar
import com.seentechs.newtaxiusers.taxiapp.datamodels.trip.Riders
import com.seentechs.newtaxiusers.taxiapp.datamodels.trip.TripDetailsModel
import com.seentechs.newtaxiusers.taxiapp.firebase_keys.FirebaseDbKeys
...
import com.seentechs.newtaxiusers.taxiapp.views.main.filter.FeatureSelectListener
import com.seentechs.newtaxiusers.taxiapp.views.main.filter.FeaturesInCarModel
...
import com.seentechs.newtaxiusers.taxiapp.views.splash.SplashActivity.Companion.checkVersionModel
...
class MainActivity : CommonActivity(), SeatsListAdapter.OnClickListener,
   ...
   /*     //Banners
        ...
        imageList.add(SlideModel("https://codeosama.com/1/4.jpg", "Enjoy Low Cost Rides"))
        imageList.add(SlideModel("https://codeosama.com/1/1.jpg", "Secure and Fast"))
        imageList.add(SlideModel("https://codeosama.com/1/3.png", "A driver is only a dial away"))
        //imageList.add(SlideModel("https://codeosama.com/1/3.png", resources.getString(R.string.privacy_policy)))
        ...
        imageSlider.setItemClickListener(object : ItemClickListener {
            override fun onItemSelected(position: Int) {
                // You can listen here
                val intent = Intent(this@MainActivity, BannerActivityCommon::class.java)
                startActivity(intent)
            }
        }) */
