...
import com.seentechs.newtaxiusers.appcommon.custompalette.FontTextView
...
import com.seentechs.newtaxiusers.appcommon.utils.CommonKeys.ACTIVITY_REQUEST_CODE_START_FACEBOOK_ACCOUNT_KIT
import com.seentechs.newtaxiusers.appcommon.utils.CommonKeys.FACEBOOK_ACCOUNT_KIT_PHONE_NUMBER_COUNTRY_CODE_KEY
import com.seentechs.newtaxiusers.appcommon.utils.CommonKeys.FACEBOOK_ACCOUNT_KIT_PHONE_NUMBER_COUNTRY_NAME_CODE_KEY
import com.seentechs.newtaxiusers.appcommon.utils.CommonKeys.FACEBOOK_ACCOUNT_KIT_PHONE_NUMBER_KEY
...
import com.seentechs.newtaxiusers.appcommon.utils.Enums
...
import com.seentechs.newtaxiusers.appcommon.utils.userchoice.UserChoiceSuccessResponse
import com.seentechs.newtaxiusers.appcommon.views.CommonActivity
import com.seentechs.newtaxiusers.taxiapp.datamodels.signinsignup.SigninResult
import com.seentechs.newtaxiusers.taxiapp.sidebar.currency.CurrencyModel
...
class SigninSignupActivity : CommonActivity(), ServiceListener, UserChoiceSuccessResponse {
    ...
    private fun openFacebookAccountKitActivity() {
        if (checkVersionModel.otpEnabled) {
            if(checkVersionModel.defaultOtp=="firebase"){
                val signin = Intent(this, PhoneActivity::class.java)
                startActivity(signin)
            }else if(checkVersionModel.defaultOtp=="twilio"){
