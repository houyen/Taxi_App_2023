		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<!-- Stripe Section End -->
					  <!-- Paytm Section Start -->
                  <div class="box-body" ng-init="paytm_enabled=<?php echo e(old('paytm_enabled',payment_gateway('is_enabled','Paytm'))); ?>">
							<div class="form-group">
								<label for="input_paytm_enabled" class="col-sm-3 control-label">Is Paytm Enabled <em class="text-danger">*</em> </label>
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('paytm_enabled', array('0' => 'No', '1' => 'Yes'), old('paytm_enabled',payment_gateway('is_enabled','Paytm')), ['class' => 'form-control', 'id' => 'input_paytm_enabled','ng-model' => 'paytm_enabled']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('paytm_mode', array('sandbox' => 'Sandbox', 'live' => 'Live'), old('paytm_mode',payment_gateway('mode','Paytm')), ['class' => 'form-control', 'id' => 'input_paytm_mode']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paytm_merchant', old('paytm_merchant',payment_gateway('paytm_merchant','Paytm')), ['class' => 'form-control', 'id' => 'input_paytm_merchant', 'placeholder' => 'Paytm']); ?>

									<span class="text-danger"><?php echo e($errors->first('paytm_merchant')); ?></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paytm_secret', old('paytm_secret',payment_gateway('paytm_secret','Paytm')), ['class' => 'form-control', 'id' => 'input_paytm_secret', 'placeholder' => 'Paytm Secret']); ?>

									<span class="text-danger"><?php echo e($errors->first('paytm_secret')); ?></span>
								</div>
							</div>
					</div>
					<!-- Paytm Section End -->
                  ...
                  <div class="box-body" ng-init="flutterwave_enabled=<?php echo e(old('flutterwave_enabled',payment_gateway('is_enabled','Flutterwave'))); ?>">
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('flutterwave_enabled', array('0' => 'No', '1' => 'Yes'), old('flutterwave_enabled',payment_gateway('is_enabled','Flutterwave')), ['class' => 'form-control', 'id' => 'input_paytm_enabled','ng-model' => 'paytm_enabled']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('flutterwave_mode', array('sandbox' => 'Sandbox', 'live' => 'Live'), old('flutterwave_mode',payment_gateway('mode','Flutterwave')), ['class' => 'form-control', 'id' => 'input_flutterwave_mode']); ?>

									<span class="text-danger"><?php echo e($errors->first('flutterwave_mode')); ?></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('flutterwave_public_key', old('flutterwave_public_key',payment_gateway('public_key','Flutterwave')), ['class' => 'form-control', 'id' => 'input_flutterwave_public_key', 'placeholder' => 'Flutterwave']); ?>

									<span class="text-danger"><?php echo e($errors->first('flutterwave_public_key')); ?></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('flutterwave_secret_key', old('flutterwave_secret_key',payment_gateway('secret_key','Flutterwave')), ['class' => 'form-control', 'id' => 'input_flutterwave_secret', 'placeholder' => 'Flutterwave Secret']); ?>
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('flutterwave_encryption_key', old('flutterwave_encryption_key',payment_gateway('encryption_key','Flutterwave')), ['class' => 'form-control', 'id' => 'input_flutterwave_encryption', 'placeholder' => 'Flutterwave Encryption Key']); ?>

									<span class="text-danger"><?php echo e($errors->first('flutterwave_encryption_key')); ?></span>
								</div>
							</div>
					</div>
					<!-- FlutterWave Section End -->
							...
							<!-- Mpesa Section Start -->
						<div class="box-body" ng-init="mpesa_enabled=<?php echo e(old('mpesa_enabled',payment_gateway('is_enabled','Mpesa'))); ?>">
							<div class="form-group">
								<label for="input_stripe_enabled" class="col-sm-3 control-label">Is Mpesa Enabled <em class="text-danger">*</em> </label>
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('mpesa_enabled', array('0' => 'No', '1' => 'Yes'), old('mpesa_enabled',payment_gateway('is_enabled','Mpesa')), ['class' => 'form-control', 'id' => 'input_mpesa_enabled','ng-model' => 'mpesa_enabled']); ?>

									<span class="text-danger"><?php echo e($errors->first('mpesa_enabled')); ?></span>
								</div>
							</div>
								<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('mpesa_mode', array('sandbox' => 'Sandbox', 'live' => 'Live'), old('mpesa_mode',payment_gateway('mode','Mpesa')), ['class' => 'form-control', 'id' => 'input_mpesa_mode']); ?>

									<span class="text-danger"><?php echo e($errors->first('mpesa_mode')); ?></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('consumer_key', old('consumer_key',payment_gateway('consumer_key','Mpesa')), ['class' => 'form-control', 'id' => 'input_consumer_key', 'placeholder' => 'Consumer Key']); ?>

									<span class="text-danger"><?php echo e($errors->first('consumer_key')); ?></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('consumer_secret', old('consumer_secret',payment_gateway('consumer_secret','Mpesa')), ['class' => 'form-control', 'id' => 'input_consumer_secret', 'placeholder' => 'Consumer Secret']); ?>

									<span class="text-danger"><?php echo e($errors->first('consumer_secret')); ?></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('callback_url', old('callback_url',payment_gateway('callback_url','Mpesa')), ['class' => 'form-control', 'id' => 'input_callback_url', 'placeholder' => 'Callback Url']); ?>

									<span class="text-danger"><?php echo e($errors->first('callback_url')); ?></span>
								</div>
							</div>
								<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('business_shortcode', old('business_shortcode',payment_gateway('business_shortcode','Mpesa')), ['class' => 'form-control', 'id' => 'input_business_shortcode', 'placeholder' => 'Business Shortcode']); ?>

									<span class="text-danger"><?php echo e($errors->first('business_shortcode')); ?></span>
								</div>
							</div>
						</div>
                  ...
                  <div class="box-body" ng-init="mollie_enabled=<?php echo e(old('mollie_enabled',payment_gateway('is_enabled','Mollie'))); ?>">
							<div class="form-group">
								<label for="input_paytm_enabled" class="col-sm-3 control-label">Is Mollie Enabled <em class="text-danger">*</em> </label>
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('mollie_enabled', array('0' => 'No', '1' => 'Yes'), old('mollie_enabled',payment_gateway('is_enabled','Mollie')), ['class' => 'form-control', 'id' => 'input_mollie_enabled','ng-model' => 'mollie_enabled']); ?>

									<span class="text-danger"><?php echo e($errors->first('mollie_enabled')); ?></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('mollie_mode', array('sandbox' => 'Sandbox', 'live' => 'Live'), old('mollie_mode',payment_gateway('mode','Mollie')), ['class' => 'form-control', 'id' => 'input_mollie_mode']); ?>

									<span class="text-danger"><?php echo e($errors->first('mollie_mode')); ?></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('mollie_key', old('mollie_key',payment_gateway('api_key','Mollie')), ['class' => 'form-control', 'id' => 'input_mollie_merchant', 'placeholder' => 'Mollie Api Key']); ?>

									<span class="text-danger"><?php echo e($errors->first('mollie_key')); ?></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('mollie_partner', old('mollie_partner',payment_gateway('partner_id','Mollie')), ['class' => 'form-control', 'id' => 'input_mollie_partner', 'placeholder' => 'Partner ID']); ?>

									<span class="text-danger"><?php echo e($errors->first('mollie_partner')); ?></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('mollie_profile', old('mollie_profile',payment_gateway('profile_id','Mollie')), ['class' => 'form-control', 'id' => 'input_mollie_profile', 'placeholder' => 'Profile ID']); ?>

									<span class="text-danger"><?php echo e($errors->first('mollie_profile')); ?></span>
								</div>
							</div>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seentec3/new.newtaxi.co/resources/views/admin/payment_gateway.blade.php ENDPATH**/ ?>