              ...
              <span class="text-danger">(*)Trường bắt buộc</span>
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    {!! Form::select('category_id', $category->pluck('name', 'id'), $result->category_id, ['class' => 'form-control', 'id' => 'input_category_id', 'placeholder'  => 'Chọn', 'ng-change' => 'change_category(category_id)', 'ng-model' => 'category_id', 'ng-init' => 'category_id = '.$result->category_id]) !!}
