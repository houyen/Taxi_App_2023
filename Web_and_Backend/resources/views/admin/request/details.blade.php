            ...
            <div class="box-body">            
              <div class="col-md-8">
                    <dl class="row">
                        ...
                        <div class="payment-details clearfix">
                            <dt class="col-sm-5">Tên tài xế </dt>
                            <dd class="col-sm-7">
                        ...
                        @isset($is_tripped)
                            @if(in_array($trip_data->status,["End trip", "Rating", "Payment", "Completed"]))
                                <div class="payment-details clearfix">
                                    <dt class="col-sm-5"> Thời gian bắt đầu </dt>
                                    <dd class="col-sm-7">
                                ...
                                @if($trip_data->status != 'End trip')
                                    <div class="payment-details clearfix">
                                        <dt class="col-sm-5"> Thời gian kết thúc </dt>
                                        <dd class="col-sm-7">
                        ...
                        <div class="payment-details clearfix">
                            <dt class="col-sm-5">Ride Trạng thái : </dt>
