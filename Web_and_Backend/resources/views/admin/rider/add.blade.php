...
<div class="content-wrapper" ng-controller="destination_admin">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="{{ url(LOGIN_USER_TYPE.'/rider') }}"> Khách hàng </a>
			</li>
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('first_name', '', ['class' => 'form-control', 'id' => 'input_first_name', 'placeholder' => 'Tên']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('last_name', '', ['class' => 'form-control', 'id' => 'input_last_name', 'placeholder' => 'Họ']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<select class ='form-control' id = 'input_country_code' name='country_code' >
									...
									<option value="{{@$country_code->phone_code}}" data-id="{{ $country_code->id }}" {{ ($country_code->id == old('country_id')) ? 'Chọn' : ''}}>{{$country_code->long_name}}</option>
									@endforeach
							...
							<div class="col-md-7 col-sm-offset-1">
								<div class="autocomplete-input-container">
									<div class="autocomplete-input">
										{!! Form::text('home_location', @$location->home_location, ['class' => 'form-control', 'id' => 'input_home_location', 'placeholder' => 'Địa chỉ nhà','autocomplete' => 'off']) !!}
									</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<div class="autocomplete-input-container">
									<div class="autocomplete-input">
										{!! Form::text('work_location', @$location->work_location, ['class' => 'form-control', 'id' => 'input_work_location', 'placeholder' => 'Địa chỉ cơ quan','autocomplete' => 'off']) !!}
									</div>
