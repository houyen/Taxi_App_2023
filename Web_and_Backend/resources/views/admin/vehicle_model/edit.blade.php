          ...
          {!! Form::open(['url' => LOGIN_USER_TYPE.'/edit-vehicle_model/'.$result->id, 'class' => 'form-horizontal','files' => true]) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                {!! Form::select('vehicle_make_id',$make, $result->vehicle_make_id, ['class' => 'form-control', 'id' => 'input_status', 'placeholder'  => 'Chọn']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                {!! Form::text('model_name', $result->model_name, ['class' => 'form-control', 'id' => 'input_make_name', 'placeholder' => 'Tên mẫu xe']) !!}
