				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::select('country_id', $country_code_option, $result->country_id, ['class' => 'form-control', 'id' => 'input_country_code', 'placeholder'  => 'Chọn']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::select('company_name_view', $company, $result->company_id, ['class' => 'form-control', 'id' => 'input_company_name', 'placeholder'  => 'Chọn','disabled']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::select('status', array('Active' => 'Hoạt động', 'Inactive'  => 'Ẩn', 'Đợi duyệt' => 'Đợi duyệt', 'Car_details' => 'Car_details', 'Document_details' => 'Document_details'), $result->status, ['class' => 'form-control', 'id' => 'input_status', 'placeholder'  => 'Chọn']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('address_line1',@$address->address_line1, ['class' => 'form-control', 'id' => 'address_line1', 'placeholder' => 'Địa chỉ 1']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('address_line2',@$address->address_line2, ['class' => 'form-control', 'id' => 'address_line2', 'placeholder' => 'Địa chỉ 2']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								...
								{!! Form::text('city',@$address->city, ['class' => 'form-control', 'id' => 'city', 'placeholder' => 'Thành phố']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								...
								{!! Form::text('state',$address->state, ['class' => 'form-control', 'id' => 'state', 'placeholder' => 'Tỉnh']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('postal_code',@$address->postal_code, ['class' => 'form-control', 'id' => 'postal_code', 'placeholder' => 'Mã bưu điện']) !!}
						...
						<div class="form-group" ng-repeat="doc in driver_doc" ng-cloak ng-if="driver_doc">
							...
							<div class="col-md-7 col-sm-offset-1" ng-if="doc.expiry_required=='1'">
								<input type="text" name="expired_date_@{{doc.id}}" min="{{ date('Y-m-d') }}" value="@{{ doc.expired_date }}" class="form-control document_expired" placeholder="Ngày hết hạn" autocomplete="off">
