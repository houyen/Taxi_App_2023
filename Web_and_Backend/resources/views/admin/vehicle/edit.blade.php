			...
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<div class="form-group">
			              <label for="input_status" class="col-sm-3 control-label">Hãng xe <em class="text-danger">*</em></label>
			              <div class="col-md-7 col-sm-offset-1">
			                {!! Form::select('vehicle_make_id',$make, $result->vehicle_make_id, ['class' => 'form-control', 'id' => 'vehicle_make', 'placeholder'  => 'Chọn']) !!}
						...
						<div class="form-group">
							<label for="default" class="col-sm-3 control-label">Mặc định <em class="text-danger">*</em></label>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1 form-check" style="padding-top: 6px;">
								{{ Form::radio('request_from', '1', in_array('1',$options) ? true:false, ['class' => 'form-check-input request_from', 'id' => 'request_from_female', 'data-error-placement'=>'container', 'data-error-container'=>'#request_from_error']) }}  <span style="margin-right: 15px;">Nữ</span>
