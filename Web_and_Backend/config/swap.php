...
return [
    ...
    */
    'services' => [
        ...
        /*'open_exchange_rates' => [
           'app_id' => env('CURRENCY_ACCESS_KEY','800c5a7fb5684a41adf595e84448dd1d'),
           'enterprise' => false,
        ]*/
        // 'currency_layer' => ['access_key' => env('CURRENCY_ACCESS_KEY', '2cd0c8e12b391be939d2c1d0a64e23b5'), 'enterprise' => false],
    ],
