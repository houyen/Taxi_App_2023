...
import com.tkpmnc.newtaxidriver.common.util.Enums.UPLOAD_VEHICLE_DOCUMENT
...
import com.tkpmnc.newtaxidriver.databinding.ViewDocumentLayoutBinding
import com.tkpmnc.newtaxidriver.home.datamodel.AddDocumentDetails
...
class ViewVehicleDocumentFragment : Fragment(), ServiceListener, ImageListener, RuntimePermissionDialogFragment.RuntimePermissionRequestedCallback, DatePickerDialog.OnDateSetListener {
    ...
    fun uploadImage() {
        ...
        RuntimePermissionDialogFragment.checkPermissionStatus(requireActivity(), requireActivity().supportFragmentManager, this, RuntimePermissionDialogFragment.IMAGE_PERMISSION_ARRAY, 0, 0)
        }else{
            RuntimePermissionDialogFragment.checkPermissionStatus(requireActivity(), requireActivity().supportFragmentManager, this, RuntimePermissionDialogFragment.CAMERA_PERMISSION_ARRAY, 0, 0)
        }
    }
