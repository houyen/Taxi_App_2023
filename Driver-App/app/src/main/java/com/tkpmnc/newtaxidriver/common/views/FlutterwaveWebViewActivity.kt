...
import com.tkpmnc.newtaxidriver.common.util.CommonKeys.PAY_TO_ADMIN
...
class FlutterwaveWebViewActivity : CommonActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonMethods.setheaderText(resources.getString(R.string.flutterwave_payment), common_header)
