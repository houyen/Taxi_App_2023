...
import com.tkpmnc.newtaxidriver.common.util.Enums.DELETE_VEHICLE
...
import com.tkpmnc.newtaxidriver.home.managevehicles.adapter.ManageVehicleAdapter
...
class ManageVehicleFragment : Fragment(), ManageVehicleAdapter.OnClickListener , ServiceListener {
    ...
    private fun initRecyclerView() {
        ...
        adapter = ManageVehicleAdapter(requireContext(),(activity as ManageVehicles).vehicleDetails,this)
