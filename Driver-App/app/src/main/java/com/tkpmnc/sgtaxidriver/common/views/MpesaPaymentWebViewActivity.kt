...
class MpesaPaymentWebViewActivity : CommonActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonMethods.setheaderText(resources.getString(R.string.mpesa_payment), common_header)
        ...
        val url = getString(R.string.apiBaseUrl) + CommonKeys.WEB_MPESA_PAY_TO_ADMIN
