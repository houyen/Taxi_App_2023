...
import com.tkpmnc.sgtaxidriver.common.util.CommonKeys.ACTIVITY_REQUEST_CODE_START_FACEBOOK_ACCOUNT_KIT
...
class SigninSignupHomeActivity : CommonActivity(), UserChoiceSuccessResponse {
    ...
    fun languagelist() {
        ...
        com.tkpmnc.sgtaxidriver.home.signinsignup.SigninSignupHomeActivity.Companion.alertDialogStores?.setOnDismissListener {
