...
import com.tkpmnc.sgtaxidriver.common.util.CommonKeys.PAY_TO_ADMIN
...
class PaytmPaymentWebViewActivity : CommonActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonMethods.setheaderText(resources.getString(R.string.patym_payment), common_header)
        ...
        val url = getString(R.string.apiBaseUrl) + CommonKeys.WEB_PAYTM_PAY_TO_ADMIN
